...
public class UserRatingService {
    ...
    @CacheEvict(value = {"userRatings", "coffeeShopRatings", "allCoffeeShops", "allCoffeeShopsMap", "coffeeShopsByTiles"}, allEntries = true)
    public UserRating createOrUpdateRating(Long userId, Long coffeeShopId, Double rating, String reviewText) {
    ...
    public Optional<UserRating> getUserRatingForCoffeeShop(Long userId, Long coffeeShopId) {
        return userRatingRepository.findByUserIdAndCoffeeShopId(userId, coffeeShopId);
    }
    ...
    public List<UserRating> getUserRatings(Long userId) {
        return userRatingRepository.findByUserIdOrderByCreatedAtDesc(userId);
    }
    
    // Get all ratings for a coffee shop
    @Cacheable(value = "coffeeShopRatings", key = "#coffeeShopId")
    @Transactional(readOnly = true)
    public List<UserRating> getCoffeeShopRatings(Long coffeeShopId) {
        return userRatingRepository.findByCoffeeShopIdOrderByCreatedAtDesc(coffeeShopId);
    }
    ...
    @CacheEvict(value = {"userRatings", "coffeeShopRatings", "userSpecificRating", "aggregatedRatings", "allCoffeeShops", "allCoffeeShopsMap", "coffeeShopsByTiles"}, allEntries = true)
